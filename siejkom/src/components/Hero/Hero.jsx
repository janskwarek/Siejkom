    ...
    <section className="hero noise">
      ...
      <div className="container hero__inner">
        <p className="hero__eyebrow">
          ...
          Od {COMPANY.founded} roku — Piekary Śl. / Siemianowice Śl.
        </p>

        <h1 className="hero__title">
          Solidny Beton,
          <br />
          <span className="hero__title-accent">Pewna</span> Inwestycja
        </h1>

        <p className="hero__subtitle">
          Specjalizujemy się w produkcji i dostawie betonu bezpośrednio na plac
          budowy. Własna flota transportowa, nowoczesne technologie i pełna
          kontrola jakości.
        </p>
